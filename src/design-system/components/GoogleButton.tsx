...
// Official four-color "G" mark, per Google's sign-in branding guidelines
// (developers.google.com/identity/branding-guidelines) — kept inline so the
// button doesn't depend on an external asset.
function GoogleIcon() {
  return (
...
export function GoogleButton({ children, className, ...rest }: GoogleButtonProps) {
